...
enemy_chances: Dict[int, List[Tuple[Entity, int]]] = {
    ...
    2: [(entity_factories.goblin, 60,), (entity_factories.hobgoblin, 30)],
    3: [(entity_factories.hobgoblin, 60), (entity_factories.orc, 30)],
